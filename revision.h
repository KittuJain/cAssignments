...
int reduceInt (int *, int, int (*)(int,int), int);
float reduceFloat (float *, int, float (*)(float,float), float);
char reduceChar (char *, int, char (*)(char,char), char);
char * reduceString (char **, int, char *(*)(char *,char *), char*);
